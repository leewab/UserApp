    ...
    public class ProtocolHandler
    {
        ...
        public void ParseProtocolInfo(string protocolStr)
        {
            ...
            else
            {
                ...
                if (protocolData is ProtocolData)
                {
                    ProtocolData data = (ProtocolData) protocolData;
                    SetProtocolData(protocolId, data);
                    ProtocolDatasAction?.Invoke(protocolId, data); //该协议事件应该是分发
                }
                else
                {
